...
{   
    ...
    private const string NODE_ID = "SPOT";
    ...
    //private const string URL_FORMAT = "{0}/node-mothership";
    //private const string URL_HUB = "http://localhost:5242";

    private static string MothershipURL = $"{string.Format(URL_FORMAT, URL_SERVICE, NODE_ID, "Version1", "SchemaVersion1", "SharedNodeVersion1", NODE_SECRET, NODE_ORGANIZATION_ID)}";
    //private static string MothershipURL = $"{string.Format(URL_FORMAT, URL_SERVICE)}";
