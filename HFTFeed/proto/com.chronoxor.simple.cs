...
namespace com.chronoxor.simple {
    ...
    public struct NewMdNotify : IComparable, IComparable<NewMdNotify>, IEquatable<NewMdNotify>
    {
        ...
        public const long FBETypeConst = 6;
        public long FBEType => FBETypeConst;

        public static NewMdNotify Default => new NewMdNotify
        {
            symbolkey = ""
            , ask = (double)0.0D
            , bid = (double)0.0D
        ...
        public NewMdNotify(string symbolkey, double ask, double bid)
        {
        ...
        public NewMdNotify Clone()
        {
            // Serialize the struct to the FBE stream
            var writer = new com.chronoxor.simple.FBE.NewMdNotifyModel();
            writer.Serialize(this);

            // Deserialize the struct from the FBE stream
            var reader = new com.chronoxor.simple.FBE.NewMdNotifyModel();
            reader.Attach(writer.Buffer);
            reader.Deserialize(out var result);
            return result;
        }
        ...
        public int CompareTo(NewMdNotify other)
        {
            int result = 0;
            return result;
        }
        ...
        public override bool Equals(object other)
        {
            if (!(other is NewMdNotify))
                return false;
            return true;
        }

        public bool Equals(NewMdNotify other)
        {
            return true;
        }
        ...
        public static bool operator==(NewMdNotify lhs, NewMdNotify rhs) => lhs.Equals(rhs);
        public static bool operator!=(NewMdNotify lhs, NewMdNotify rhs) => !(lhs == rhs);

        public override string ToString()
        {
            var sb = new StringBuilder();
            sb.Append("NewMdNotify(");
            sb.Append("symbolkey="); if (symbolkey != null) sb.Append("\"").Append(symbolkey).Append("\""); else sb.Append("null");
            sb.Append(",ask="); sb.Append(ask.ToString(CultureInfo.InvariantCulture));
            sb.Append(",bid="); sb.Append(bid.ToString(CultureInfo.InvariantCulture));
            sb.Append(")");
            return sb.ToString();
        }

        public static com.chronoxor.FBE.FieldModelValueType<NewMdNotify> CreateFieldModel(com.chronoxor.FBE.Buffer buffer, long offset) { return new simple.FBE.FieldModelNewMdNotify(buffer, offset); }
    }
...
namespace com.chronoxor.simple.FBE {
    ...
    // Fast Binary Encoding NewMdNotify field model
    public class FieldModelNewMdNotify : com.chronoxor.FBE.FieldModelValueType<NewMdNotify>
    {
        public readonly com.chronoxor.FBE.FieldModelReferenceType<string> symbolkey;
        public readonly com.chronoxor.FBE.FieldModelValueType<double> ask;
        public readonly com.chronoxor.FBE.FieldModelValueType<double> bid;

        public FieldModelNewMdNotify(com.chronoxor.FBE.Buffer buffer, long offset) : base(buffer, offset)
        {
            symbolkey = com.chronoxor.FBE.FieldModelReferenceType<string>.CreateFieldModel(com.chronoxor.FBE.BaseTypes.STRING, buffer, 4 + 4);
            ask = com.chronoxor.FBE.FieldModelValueType<double>.CreateFieldModel(com.chronoxor.FBE.BaseTypes.DOUBLE, buffer, symbolkey.FBEOffset + symbolkey.FBESize);
            bid = com.chronoxor.FBE.FieldModelValueType<double>.CreateFieldModel(com.chronoxor.FBE.BaseTypes.DOUBLE, buffer, ask.FBEOffset + ask.FBESize);
        }
        ...
        // Clone the field model
        public override com.chronoxor.FBE.FieldModelValueType<NewMdNotify> Clone() { return new FieldModelNewMdNotify(_buffer, _offset); }
        ...
        public bool VerifyFields(long fbeStructSize)
        {
            ...
            if ((fbeCurrentSize + symbolkey.FBESize) > fbeStructSize)
                return true;
            if (!symbolkey.Verify())
                return false;
            fbeCurrentSize += symbolkey.FBESize;

            if ((fbeCurrentSize + ask.FBESize) > fbeStructSize)
                return true;
            if (!ask.Verify())
                return false;
            fbeCurrentSize += ask.FBESize;

            if ((fbeCurrentSize + bid.FBESize) > fbeStructSize)
                return true;
            if (!bid.Verify())
                return false;
            fbeCurrentSize += bid.FBESize;
        ...
        // Get the struct value
        public override void Get(out NewMdNotify fbeValue) { Get(out fbeValue, NewMdNotify.Default); }
        public override void Get(out NewMdNotify fbeValue, NewMdNotify defaults)
        {
            long fbeBegin = GetBegin();
            if (fbeBegin == 0)
            {
        ...
        // Get the struct fields values
        public void GetFields(out NewMdNotify fbeValue, long fbeStructSize)
        {
            long fbeCurrentSize = 4 + 4;

            fbeValue = NewMdNotify.Default;

            if ((fbeCurrentSize + symbolkey.FBESize) <= fbeStructSize)
                symbolkey.Get(out fbeValue.symbolkey);
            else
                fbeValue.symbolkey = "";
            fbeCurrentSize += symbolkey.FBESize;

            if ((fbeCurrentSize + ask.FBESize) <= fbeStructSize)
                ask.Get(out fbeValue.ask, (double)0.0D);
            else
                fbeValue.ask = (double)0.0D;
            fbeCurrentSize += ask.FBESize;

            if ((fbeCurrentSize + bid.FBESize) <= fbeStructSize)
                bid.Get(out fbeValue.bid, (double)0.0D);
            else
                fbeValue.bid = (double)0.0D;
            fbeCurrentSize += bid.FBESize;
        }
        ...
        // Set the struct value
        public override void Set(NewMdNotify fbeValue)
        {
            long fbeBegin = SetBegin();
            if (fbeBegin == 0)
                return;
        ...
        // Set the struct fields values
        public void SetFields(NewMdNotify fbeValue)
        {
            symbolkey.Set(fbeValue.symbolkey);
            ask.Set(fbeValue.ask);
            bid.Set(fbeValue.bid);
        }
    }
...
namespace com.chronoxor.simple.FBE {
    ...
    // Fast Binary Encoding NewMdNotify model
    public class NewMdNotifyModel : com.chronoxor.FBE.Model
    {
        public readonly FieldModelNewMdNotify model;

        public NewMdNotifyModel() { model = new FieldModelNewMdNotify(Buffer, 4); }
        public NewMdNotifyModel(com.chronoxor.FBE.Buffer buffer) : base(buffer) { model = new FieldModelNewMdNotify(Buffer, 4); }

        // Get the model size
        public long FBESize => model.FBESize + model.FBEExtra;
        // Get the model type
        public const long FBETypeConst = FieldModelNewMdNotify.FBETypeConst;
        public long FBEType => FBETypeConst;
        ...
        // Serialize the struct value
        public long Serialize(NewMdNotify value)
        {
            long fbeBegin = CreateBegin();
            model.Set(value);
            long fbeFullSize = CreateEnd(fbeBegin);
        ...
        // Deserialize the struct value
        public long Deserialize(out NewMdNotify value)
        {
            if ((Buffer.Offset + model.FBEOffset - 4) > Buffer.Size)
            {
                value = NewMdNotify.Default;
                return 0;
            }
...
namespace com.chronoxor.simple {
    ...
    public struct GetSymbolRequest : IComparable, IComparable<GetSymbolRequest>, IEquatable<GetSymbolRequest>
    {
        public Guid id => Guid.Empty;

        public const long FBETypeConst = 7;
        public long FBEType => FBETypeConst;

        public static GetSymbolRequest Default => new GetSymbolRequest
        {
        };

        public GetSymbolRequest Clone()
        {
            // Serialize the struct to the FBE stream
            var writer = new com.chronoxor.simple.FBE.GetSymbolRequestModel();
            writer.Serialize(this);

            // Deserialize the struct from the FBE stream
            var reader = new com.chronoxor.simple.FBE.GetSymbolRequestModel();
            reader.Attach(writer.Buffer);
            reader.Deserialize(out var result);
            return result;
        }
        ...
        public int CompareTo(GetSymbolRequest other)
        {
            int result = 0;
            return result;
        }
        ...
        public override bool Equals(object other)
        {
            if (!(other is GetSymbolRequest))
                return false;
            return true;
        }

        public bool Equals(GetSymbolRequest other)
        {
            return true;
        }
        ...
        public static bool operator==(GetSymbolRequest lhs, GetSymbolRequest rhs) => lhs.Equals(rhs);
        public static bool operator!=(GetSymbolRequest lhs, GetSymbolRequest rhs) => !(lhs == rhs);

        public override string ToString()
        {
            var sb = new StringBuilder();
            sb.Append("GetSymbolRequest(");
            sb.Append(")");
            return sb.ToString();
        }

        public static com.chronoxor.FBE.FieldModelValueType<GetSymbolRequest> CreateFieldModel(com.chronoxor.FBE.Buffer buffer, long offset) { return new simple.FBE.FieldModelGetSymbolRequest(buffer, offset); }
    }
...
namespace com.chronoxor.simple.FBE {
    ...
    // Fast Binary Encoding GetSymbolRequest field model
    public class FieldModelGetSymbolRequest : com.chronoxor.FBE.FieldModelValueType<GetSymbolRequest>
    {

        public FieldModelGetSymbolRequest(com.chronoxor.FBE.Buffer buffer, long offset) : base(buffer, offset)
        {
        }
        ...
        // Clone the field model
        public override com.chronoxor.FBE.FieldModelValueType<GetSymbolRequest> Clone() { return new FieldModelGetSymbolRequest(_buffer, _offset); }
        ...
        // Get the struct value
        public override void Get(out GetSymbolRequest fbeValue) { Get(out fbeValue, GetSymbolRequest.Default); }
        public override void Get(out GetSymbolRequest fbeValue, GetSymbolRequest defaults)
        {
            long fbeBegin = GetBegin();
            if (fbeBegin == 0)
            {
        ...
        // Get the struct fields values
        public void GetFields(out GetSymbolRequest fbeValue, long fbeStructSize)
        {
        }
        ...
        // Set the struct value
        public override void Set(GetSymbolRequest fbeValue)
        {
            long fbeBegin = SetBegin();
            if (fbeBegin == 0)
                return;
        ...
        // Set the struct fields values
        public void SetFields(GetSymbolRequest fbeValue)
        {
        }
    }
...
namespace com.chronoxor.simple.FBE {
    ...
    // Fast Binary Encoding GetSymbolRequest model
    public class GetSymbolRequestModel : com.chronoxor.FBE.Model
    {
        public readonly FieldModelGetSymbolRequest model;

        public GetSymbolRequestModel() { model = new FieldModelGetSymbolRequest(Buffer, 4); }
        public GetSymbolRequestModel(com.chronoxor.FBE.Buffer buffer) : base(buffer) { model = new FieldModelGetSymbolRequest(Buffer, 4); }

        // Get the model size
        public long FBESize => model.FBESize + model.FBEExtra;
        // Get the model type
        public const long FBETypeConst = FieldModelGetSymbolRequest.FBETypeConst;
        public long FBEType => FBETypeConst;
        ...
        // Serialize the struct value
        public long Serialize(GetSymbolRequest value)
        {
            long fbeBegin = CreateBegin();
            model.Set(value);
            long fbeFullSize = CreateEnd(fbeBegin);
        ...
        // Deserialize the struct value
        public long Deserialize(out GetSymbolRequest value)
        {
            if ((Buffer.Offset + model.FBEOffset - 4) > Buffer.Size)
            {
                value = GetSymbolRequest.Default;
                return 0;
            }
...
namespace com.chronoxor.simple {
    ...
    public struct GetSymbolResponse : IComparable, IComparable<GetSymbolResponse>, IEquatable<GetSymbolResponse>
    {
        public List<string> Symbols;
        public Guid id => Guid.Empty;

        public const long FBETypeConst = 8;
        public long FBEType => FBETypeConst;

        public static GetSymbolResponse Default => new GetSymbolResponse
        {
            Symbols = new List<string>()
        };

        public GetSymbolResponse(List<string> Symbols)
        {
            this.Symbols = Symbols;
        }

        public GetSymbolResponse Clone()
        {
            // Serialize the struct to the FBE stream
            var writer = new com.chronoxor.simple.FBE.GetSymbolResponseModel();
            writer.Serialize(this);

            // Deserialize the struct from the FBE stream
            var reader = new com.chronoxor.simple.FBE.GetSymbolResponseModel();
            reader.Attach(writer.Buffer);
            reader.Deserialize(out var result);
            return result;
        }
        ...
        public int CompareTo(GetSymbolResponse other)
        {
            int result = 0;
            return result;
        }
        ...
        public override bool Equals(object other)
        {
            if (!(other is GetSymbolResponse))
                return false;
            return true;
        }

        public bool Equals(GetSymbolResponse other)
        {
            return true;
        }
        ...
        public static bool operator==(GetSymbolResponse lhs, GetSymbolResponse rhs) => lhs.Equals(rhs);
        public static bool operator!=(GetSymbolResponse lhs, GetSymbolResponse rhs) => !(lhs == rhs);

        public override string ToString()
        {
            var sb = new StringBuilder();
            sb.Append("GetSymbolResponse(");
            if (Symbols != null)
            {
                bool first = true;
                sb.Append("Symbols=[").Append(Symbols.Count).Append("][");
                foreach (var item in Symbols)
                {
                    if (item != null) sb.Append(first ? "" : ",").Append("\"").Append(item).Append("\""); else sb.Append(first ? "" : ",").Append("null");
                    first = false;
                }
                sb.Append("]");
            }
        ...
        public static com.chronoxor.FBE.FieldModelValueType<GetSymbolResponse> CreateFieldModel(com.chronoxor.FBE.Buffer buffer, long offset) { return new simple.FBE.FieldModelGetSymbolResponse(buffer, offset); }
    }
...
namespace com.chronoxor.simple.FBE {
    ...
    // Fast Binary Encoding GetSymbolResponse field model
    public class FieldModelGetSymbolResponse : com.chronoxor.FBE.FieldModelValueType<GetSymbolResponse>
    {
        public readonly com.chronoxor.FBE.FieldModelVectorReferenceType<string, com.chronoxor.FBE.FieldModelReferenceType<string>> Symbols;

        public FieldModelGetSymbolResponse(com.chronoxor.FBE.Buffer buffer, long offset) : base(buffer, offset)
        {
            Symbols = new com.chronoxor.FBE.FieldModelVectorReferenceType<string, com.chronoxor.FBE.FieldModelReferenceType<string>>(com.chronoxor.FBE.FieldModelReferenceType<string>.CreateFieldModel(com.chronoxor.FBE.BaseTypes.STRING, buffer, 4 + 4), buffer, 4 + 4);
        }
        ...
        // Clone the field model
        public override com.chronoxor.FBE.FieldModelValueType<GetSymbolResponse> Clone() { return new FieldModelGetSymbolResponse(_buffer, _offset); }
        ...
        public bool VerifyFields(long fbeStructSize)
        {
            ...
            if ((fbeCurrentSize + Symbols.FBESize) > fbeStructSize)
                return true;
            if (!Symbols.Verify())
                return false;
            fbeCurrentSize += Symbols.FBESize;
        ...
        // Get the struct value
        public override void Get(out GetSymbolResponse fbeValue) { Get(out fbeValue, GetSymbolResponse.Default); }
        public override void Get(out GetSymbolResponse fbeValue, GetSymbolResponse defaults)
        {
            long fbeBegin = GetBegin();
            if (fbeBegin == 0)
            {
        ...
        // Get the struct fields values
        public void GetFields(out GetSymbolResponse fbeValue, long fbeStructSize)
        {
            long fbeCurrentSize = 4 + 4;

            fbeValue = GetSymbolResponse.Default;

            if ((fbeCurrentSize + Symbols.FBESize) <= fbeStructSize)
                Symbols.Get(ref fbeValue.Symbols);
            else
                fbeValue.Symbols.Clear();
            fbeCurrentSize += Symbols.FBESize;
        }
        ...
        // Set the struct value
        public override void Set(GetSymbolResponse fbeValue)
        {
            long fbeBegin = SetBegin();
            if (fbeBegin == 0)
                return;
        ...
        // Set the struct fields values
        public void SetFields(GetSymbolResponse fbeValue)
        {
            Symbols.Set(fbeValue.Symbols);
        }
    }
...
namespace com.chronoxor.simple.FBE {
    ...
    // Fast Binary Encoding GetSymbolResponse model
    public class GetSymbolResponseModel : com.chronoxor.FBE.Model
    {
        public readonly FieldModelGetSymbolResponse model;

        public GetSymbolResponseModel() { model = new FieldModelGetSymbolResponse(Buffer, 4); }
        public GetSymbolResponseModel(com.chronoxor.FBE.Buffer buffer) : base(buffer) { model = new FieldModelGetSymbolResponse(Buffer, 4); }

        // Get the model size
        public long FBESize => model.FBESize + model.FBEExtra;
        // Get the model type
        public const long FBETypeConst = FieldModelGetSymbolResponse.FBETypeConst;
        public long FBEType => FBETypeConst;
        ...
        // Serialize the struct value
        public long Serialize(GetSymbolResponse value)
        {
            long fbeBegin = CreateBegin();
            model.Set(value);
            long fbeFullSize = CreateEnd(fbeBegin);
        ...
        // Deserialize the struct value
        public long Deserialize(out GetSymbolResponse value)
        {
            if ((Buffer.Offset + model.FBEOffset - 4) > Buffer.Size)
            {
                value = GetSymbolResponse.Default;
                return 0;
            }
...
namespace com.chronoxor.simple.FBE {
    ...
    public class Sender : com.chronoxor.FBE.Sender, ISenderListener
    {
        ...
        public readonly NewMdNotifyModel NewMdNotifyModel;
        public readonly GetSymbolRequestModel GetSymbolRequestModel;
        public readonly GetSymbolResponseModel GetSymbolResponseModel;
        ...
        public Sender() : base(false)
        {
            ...
            NewMdNotifyModel = new NewMdNotifyModel(Buffer);
            GetSymbolRequestModel = new GetSymbolRequestModel(Buffer);
            GetSymbolResponseModel = new GetSymbolResponseModel(Buffer);
        }
        ...
        public long SendListener(ISenderListener listener, object obj)
        {
            switch (obj)
            {
                ...
                case global::com.chronoxor.simple.NewMdNotify value when value.FBEType == global::com.chronoxor.simple.NewMdNotify.FBETypeConst: return SendListener(listener, value);
                case global::com.chronoxor.simple.GetSymbolRequest value when value.FBEType == global::com.chronoxor.simple.GetSymbolRequest.FBETypeConst: return SendListener(listener, value);
                case global::com.chronoxor.simple.GetSymbolResponse value when value.FBEType == global::com.chronoxor.simple.GetSymbolResponse.FBETypeConst: return SendListener(listener, value);
                default: break;
            }
        ...
        public long Send(global::com.chronoxor.simple.NewMdNotify value) { return SendListener(this, value); }
        public long SendListener(ISenderListener listener, global::com.chronoxor.simple.NewMdNotify value)
        {
            // Serialize the value into the FBE stream
            long serialized = NewMdNotifyModel.Serialize(value);
            Debug.Assert((serialized > 0), "com.chronoxor.simple.NewMdNotify serialization failed!");
            Debug.Assert(NewMdNotifyModel.Verify(), "com.chronoxor.simple.NewMdNotify validation failed!");
        ...
        public long Send(global::com.chronoxor.simple.GetSymbolRequest value) { return SendListener(this, value); }
        public long SendListener(ISenderListener listener, global::com.chronoxor.simple.GetSymbolRequest value)
        {
            // Serialize the value into the FBE stream
            long serialized = GetSymbolRequestModel.Serialize(value);
            Debug.Assert((serialized > 0), "com.chronoxor.simple.GetSymbolRequest serialization failed!");
            Debug.Assert(GetSymbolRequestModel.Verify(), "com.chronoxor.simple.GetSymbolRequest validation failed!");
        ...
        public long Send(global::com.chronoxor.simple.GetSymbolResponse value) { return SendListener(this, value); }
        public long SendListener(ISenderListener listener, global::com.chronoxor.simple.GetSymbolResponse value)
        {
            // Serialize the value into the FBE stream
            long serialized = GetSymbolResponseModel.Serialize(value);
            Debug.Assert((serialized > 0), "com.chronoxor.simple.GetSymbolResponse serialization failed!");
            Debug.Assert(GetSymbolResponseModel.Verify(), "com.chronoxor.simple.GetSymbolResponse validation failed!");
...
namespace com.chronoxor.simple.FBE {
    ...
    public interface IReceiverListener : com.chronoxor.FBE.IReceiverListener
    {
        ...
        void OnReceive(global::com.chronoxor.simple.NewMdNotify value) {}
        void OnReceive(global::com.chronoxor.simple.GetSymbolRequest value) {}
        void OnReceive(global::com.chronoxor.simple.GetSymbolResponse value) {}
    }
    ...
    public class Receiver : com.chronoxor.FBE.Receiver, IReceiverListener
    {
        ...
        private global::com.chronoxor.simple.NewMdNotify NewMdNotifyValue;
        private global::com.chronoxor.simple.GetSymbolRequest GetSymbolRequestValue;
        private global::com.chronoxor.simple.GetSymbolResponse GetSymbolResponseValue;
        ...
        private readonly NewMdNotifyModel NewMdNotifyModel;
        private readonly GetSymbolRequestModel GetSymbolRequestModel;
        private readonly GetSymbolResponseModel GetSymbolResponseModel;
        ...
        public Receiver() : base(false)
        {
            ...
            NewMdNotifyValue = global::com.chronoxor.simple.NewMdNotify.Default;
            NewMdNotifyModel = new NewMdNotifyModel();
            GetSymbolRequestValue = global::com.chronoxor.simple.GetSymbolRequest.Default;
            GetSymbolRequestModel = new GetSymbolRequestModel();
            GetSymbolResponseValue = global::com.chronoxor.simple.GetSymbolResponse.Default;
            GetSymbolResponseModel = new GetSymbolResponseModel();
        }
        ...
        internal bool OnReceiveListener(IReceiverListener listener, long type, byte[] buffer, long offset, long size)
        {
            switch (type)
            {
                ...
                case NewMdNotifyModel.FBETypeConst:
                {
                    // Deserialize the value from the FBE stream
                    NewMdNotifyModel.Attach(buffer, offset);
                    Debug.Assert(NewMdNotifyModel.Verify(), "com.chronoxor.simple.NewMdNotify validation failed!");
                    long deserialized = NewMdNotifyModel.Deserialize(out NewMdNotifyValue);
                    Debug.Assert((deserialized > 0), "com.chronoxor.simple.NewMdNotify deserialization failed!");

                    // Log the value
                    if (Logging)
                    {
                        string message = NewMdNotifyValue.ToString();
                        listener.OnReceiveLog(message);
                    }

                    // Call receive handler with deserialized value
                    listener.OnReceive(NewMdNotifyValue);
                    return true;
                }
                case GetSymbolRequestModel.FBETypeConst:
                {
                    // Deserialize the value from the FBE stream
                    GetSymbolRequestModel.Attach(buffer, offset);
                    Debug.Assert(GetSymbolRequestModel.Verify(), "com.chronoxor.simple.GetSymbolRequest validation failed!");
                    long deserialized = GetSymbolRequestModel.Deserialize(out GetSymbolRequestValue);
                    Debug.Assert((deserialized > 0), "com.chronoxor.simple.GetSymbolRequest deserialization failed!");

                    // Log the value
                    if (Logging)
                    {
                        string message = GetSymbolRequestValue.ToString();
                        listener.OnReceiveLog(message);
                    }

                    // Call receive handler with deserialized value
                    listener.OnReceive(GetSymbolRequestValue);
                    return true;
                }
                case GetSymbolResponseModel.FBETypeConst:
                {
                    // Deserialize the value from the FBE stream
                    GetSymbolResponseModel.Attach(buffer, offset);
                    Debug.Assert(GetSymbolResponseModel.Verify(), "com.chronoxor.simple.GetSymbolResponse validation failed!");
                    long deserialized = GetSymbolResponseModel.Deserialize(out GetSymbolResponseValue);
                    Debug.Assert((deserialized > 0), "com.chronoxor.simple.GetSymbolResponse deserialization failed!");

                    // Log the value
                    if (Logging)
                    {
                        string message = GetSymbolResponseValue.ToString();
                        listener.OnReceiveLog(message);
                    }

                    // Call receive handler with deserialized value
                    listener.OnReceive(GetSymbolResponseValue);
                    return true;
                }
                default: break;
            }
...
namespace com.chronoxor.simple.FBE {
    ...
    public interface IProxyListener : com.chronoxor.FBE.IReceiverListener
    {
        ...
        void OnProxy(NewMdNotifyModel model, long type, byte[] buffer, long offset, long size) {}
        void OnProxy(GetSymbolRequestModel model, long type, byte[] buffer, long offset, long size) {}
        void OnProxy(GetSymbolResponseModel model, long type, byte[] buffer, long offset, long size) {}
    }
        ...
        internal bool OnReceiveListener(IProxyListener listener, long type, byte[] buffer, long offset, long size)
        {
            switch (type)
            {
                ...
                case NewMdNotifyModel.FBETypeConst:
                {
                    ...
                    long fbeBegin = NewMdNotifyModel.model.GetBegin();
                    if (fbeBegin == 0)
                        return false;
                    // Call proxy handler
                    listener.OnProxy(NewMdNotifyModel, type, buffer, offset, size);
                    NewMdNotifyModel.model.GetEnd(fbeBegin);
                    return true;
                }
                case GetSymbolRequestModel.FBETypeConst:
                {
                    ...
                    long fbeBegin = GetSymbolRequestModel.model.GetBegin();
                    if (fbeBegin == 0)
                        return false;
                    // Call proxy handler
                    listener.OnProxy(GetSymbolRequestModel, type, buffer, offset, size);
                    GetSymbolRequestModel.model.GetEnd(fbeBegin);
                    return true;
                }
                case GetSymbolResponseModel.FBETypeConst:
                {
                    ...
                    long fbeBegin = GetSymbolResponseModel.model.GetBegin();
                    if (fbeBegin == 0)
                        return false;
                    // Call proxy handler
                    listener.OnProxy(GetSymbolResponseModel, type, buffer, offset, size);
                    GetSymbolResponseModel.model.GetEnd(fbeBegin);
                    return true;
                }
                default: break;
            }
...
namespace com.chronoxor.simple.FBE {
    ...
    public class Client : com.chronoxor.FBE.Client, IClientListener
    {
        ...
        public readonly NewMdNotifyModel NewMdNotifySenderModel;
        public readonly GetSymbolRequestModel GetSymbolRequestSenderModel;
        public readonly GetSymbolResponseModel GetSymbolResponseSenderModel;
        ...
        private global::com.chronoxor.simple.NewMdNotify NewMdNotifyReceiverValue;
        private global::com.chronoxor.simple.GetSymbolRequest GetSymbolRequestReceiverValue;
        private global::com.chronoxor.simple.GetSymbolResponse GetSymbolResponseReceiverValue;
        ...
        private readonly NewMdNotifyModel NewMdNotifyReceiverModel;
        private readonly GetSymbolRequestModel GetSymbolRequestReceiverModel;
        private readonly GetSymbolResponseModel GetSymbolResponseReceiverModel;

        // Client requests cache fields
        private Dictionary<Guid, Tuple<DateTime, TimeSpan, TaskCompletionSource<global::com.chronoxor.simple.GetSymbolResponse>>> _requestsByIdGetSymbolResponse;
        private SortedDictionary<DateTime, Guid> _requestsByTimestampGetSymbolResponse;
        ...
        public Client() : base(false)
        {
            ...
            NewMdNotifySenderModel = new NewMdNotifyModel(SendBuffer);
            NewMdNotifyReceiverValue = global::com.chronoxor.simple.NewMdNotify.Default;
            NewMdNotifyReceiverModel = new NewMdNotifyModel();
            GetSymbolRequestSenderModel = new GetSymbolRequestModel(SendBuffer);
            GetSymbolRequestReceiverValue = global::com.chronoxor.simple.GetSymbolRequest.Default;
            GetSymbolRequestReceiverModel = new GetSymbolRequestModel();
            GetSymbolResponseSenderModel = new GetSymbolResponseModel(SendBuffer);
            GetSymbolResponseReceiverValue = global::com.chronoxor.simple.GetSymbolResponse.Default;
            GetSymbolResponseReceiverModel = new GetSymbolResponseModel();
            _requestsByIdGetSymbolResponse = new Dictionary<Guid, Tuple<DateTime, TimeSpan, TaskCompletionSource<global::com.chronoxor.simple.GetSymbolResponse>>>();
            _requestsByTimestampGetSymbolResponse = new SortedDictionary<DateTime, Guid>();
        ...
        public Task<global::com.chronoxor.simple.SimpleResponse> RequestListener(IClientListener listener, global::com.chronoxor.simple.SimpleRequest value, TimeSpan timeout)
        {
            lock (Lock)
            {
                var source = new TaskCompletionSource<global::com.chronoxor.simple.SimpleResponse>();
        ...
        public Task<global::com.chronoxor.simple.GetSymbolResponse> Request(global::com.chronoxor.simple.GetSymbolRequest value) { return RequestListener(this, value, TimeSpan.Zero); }
        public Task<global::com.chronoxor.simple.GetSymbolResponse> Request(global::com.chronoxor.simple.GetSymbolRequest value, TimeSpan timeout) { return RequestListener(this, value, timeout); }
        public Task<global::com.chronoxor.simple.GetSymbolResponse> RequestListener(IClientListener listener, global::com.chronoxor.simple.GetSymbolRequest value) { return RequestListener(listener, value, TimeSpan.Zero); }
        public Task<global::com.chronoxor.simple.GetSymbolResponse> RequestListener(IClientListener listener, global::com.chronoxor.simple.GetSymbolRequest value, TimeSpan timeout)
        {
            lock (Lock)
            {
                var source = new TaskCompletionSource<global::com.chronoxor.simple.GetSymbolResponse>();
                Task<global::com.chronoxor.simple.GetSymbolResponse> task = source.Task;
                ...
                if (serialized > 0)
                {
                    ...
                    // Register the request
                    _requestsByIdGetSymbolResponse.Add(value.id, new Tuple<DateTime, TimeSpan, TaskCompletionSource<global::com.chronoxor.simple.GetSymbolResponse>>(Timestamp, timeout, source));
                    if (timeout.Ticks > 0)
                        _requestsByTimestampGetSymbolResponse.Add(Timestamp, value.id);
                }
                else
                    source.SetException(new Exception("Send request failed!"));
        ...
        public long Send(global::com.chronoxor.simple.NewMdNotify value) { return SendListener(this, value); }
        public long SendListener(IClientListener listener, global::com.chronoxor.simple.NewMdNotify value)
        {
            // Serialize the value into the FBE stream
            long serialized = NewMdNotifySenderModel.Serialize(value);
            Debug.Assert((serialized > 0), "com.chronoxor.simple.NewMdNotify serialization failed!");
            Debug.Assert(NewMdNotifySenderModel.Verify(), "com.chronoxor.simple.NewMdNotify validation failed!");
        ...
        public long Send(global::com.chronoxor.simple.GetSymbolRequest value) { return SendListener(this, value); }
        public long SendListener(IClientListener listener, global::com.chronoxor.simple.GetSymbolRequest value)
        {
            // Serialize the value into the FBE stream
            long serialized = GetSymbolRequestSenderModel.Serialize(value);
            Debug.Assert((serialized > 0), "com.chronoxor.simple.GetSymbolRequest serialization failed!");
            Debug.Assert(GetSymbolRequestSenderModel.Verify(), "com.chronoxor.simple.GetSymbolRequest validation failed!");
        ...
        public long Send(global::com.chronoxor.simple.GetSymbolResponse value) { return SendListener(this, value); }
        public long SendListener(IClientListener listener, global::com.chronoxor.simple.GetSymbolResponse value)
        {
            // Serialize the value into the FBE stream
            long serialized = GetSymbolResponseSenderModel.Serialize(value);
            Debug.Assert((serialized > 0), "com.chronoxor.simple.GetSymbolResponse serialization failed!");
            Debug.Assert(GetSymbolResponseSenderModel.Verify(), "com.chronoxor.simple.GetSymbolResponse validation failed!");
        ...
        public bool OnReceiveResponse(global::com.chronoxor.simple.GetSymbolResponse response)
        {
            ReceivedResponse_GetSymbolResponse?.Invoke(response);

            lock (Lock)
            {
                if (_requestsByIdGetSymbolResponse.TryGetValue(response.id, out Tuple<DateTime, TimeSpan, TaskCompletionSource<global::com.chronoxor.simple.GetSymbolResponse>> tuple))
                {
                    var timestamp = tuple.Item1;
                    var timespan = tuple.Item2;
                    var source = tuple.Item3;
                    source.SetResult(response);
                    _requestsByIdGetSymbolResponse.Remove(response.id);
                    _requestsByTimestampGetSymbolResponse.Remove(timestamp);
                    return true;
                }
        ...
        public bool OnReceiveResponse(global::com.chronoxor.simple.NewMdNotify response) { ReceivedResponse_NewMdNotify?.Invoke(response); return false; }
        public bool OnReceiveResponse(global::com.chronoxor.simple.GetSymbolRequest response) { ReceivedResponse_GetSymbolRequest?.Invoke(response); return false; }
        ...
        public bool OnReceiveReject(global::com.chronoxor.simple.NewMdNotify reject) { ReceivedReject_NewMdNotify?.Invoke(reject); return false; }
        public bool OnReceiveReject(global::com.chronoxor.simple.GetSymbolRequest reject) { ReceivedReject_GetSymbolRequest?.Invoke(reject); return false; }
        public bool OnReceiveReject(global::com.chronoxor.simple.GetSymbolResponse reject) { ReceivedReject_GetSymbolResponse?.Invoke(reject); return false; }
        ...
        public void OnReceiveNotify(global::com.chronoxor.simple.NewMdNotify notify) { ReceivedNotify_NewMdNotify?.Invoke(notify); }
        public void OnReceiveNotify(global::com.chronoxor.simple.GetSymbolRequest notify) { ReceivedNotify_GetSymbolRequest?.Invoke(notify); }
        public void OnReceiveNotify(global::com.chronoxor.simple.GetSymbolResponse notify) { ReceivedNotify_GetSymbolResponse?.Invoke(notify); }
        ...
        public void OnReceive(global::com.chronoxor.simple.NewMdNotify value) { if (!OnReceiveResponse(value) && !OnReceiveReject(value)) OnReceiveNotify(value); }
        public void OnReceive(global::com.chronoxor.simple.GetSymbolRequest value) { if (!OnReceiveResponse(value) && !OnReceiveReject(value)) OnReceiveNotify(value); }
        public void OnReceive(global::com.chronoxor.simple.GetSymbolResponse value) { if (!OnReceiveResponse(value) && !OnReceiveReject(value)) OnReceiveNotify(value); }
        ...
        internal override void ResetRequests()
        {
            ...
            foreach(var request in _requestsByIdGetSymbolResponse)
                request.Value.Item3.SetException(new Exception("Reset client!"));
            _requestsByIdGetSymbolResponse.Clear();
            _requestsByTimestampGetSymbolResponse.Clear();
        ...
        internal override void WatchdogRequests(DateTime utc)
        {
            ...
            while (_requestsByTimestampGetSymbolResponse.Count > 0)
            {
                var request = _requestsByTimestampGetSymbolResponse.First();
                Tuple<DateTime, TimeSpan, TaskCompletionSource<global::com.chronoxor.simple.GetSymbolResponse>> tuple;
                _requestsByIdGetSymbolResponse.TryGetValue(request.Value, out tuple);
                var timestamp = tuple.Item1;
                var timespan = tuple.Item2;
                if ((timestamp + timespan) <= utc)
                {
                    ...
                    _requestsByIdGetSymbolResponse.Remove(request.Value);
                    _requestsByTimestampGetSymbolResponse.Remove(timestamp);
                    continue;
                }
                else
        ...
        internal bool OnReceiveListener(IClientListener listener, long type, byte[] buffer, long offset, long size)
        {
            switch (type)
            {
                ...
                {
                    // Deserialize the value from the FBE stream
                    NewMdNotifyReceiverModel.Attach(buffer, offset);
                    Debug.Assert(NewMdNotifyReceiverModel.Verify(), "com.chronoxor.simple.NewMdNotify validation failed!");
                    long deserialized = NewMdNotifyReceiverModel.Deserialize(out NewMdNotifyReceiverValue);
                    Debug.Assert((deserialized > 0), "com.chronoxor.simple.NewMdNotify deserialization failed!");

                    // Log the value
                    if (Logging)
                    {
                        string message = NewMdNotifyReceiverValue.ToString();
                        listener.OnReceiveLog(message);
                    }

                    // Call receive handler with deserialized value
                    listener.OnReceive(NewMdNotifyReceiverValue);
                    return true;
                }
                case GetSymbolRequestModel.FBETypeConst:
                {
                    // Deserialize the value from the FBE stream
                    GetSymbolRequestReceiverModel.Attach(buffer, offset);
                    Debug.Assert(GetSymbolRequestReceiverModel.Verify(), "com.chronoxor.simple.GetSymbolRequest validation failed!");
                    long deserialized = GetSymbolRequestReceiverModel.Deserialize(out GetSymbolRequestReceiverValue);
                    Debug.Assert((deserialized > 0), "com.chronoxor.simple.GetSymbolRequest deserialization failed!");

                    // Log the value
                    if (Logging)
                    {
                        string message = GetSymbolRequestReceiverValue.ToString();
                        listener.OnReceiveLog(message);
                    }

                    // Call receive handler with deserialized value
                    listener.OnReceive(GetSymbolRequestReceiverValue);
                    return true;
                }
                case GetSymbolResponseModel.FBETypeConst:
                {
                    // Deserialize the value from the FBE stream
                    GetSymbolResponseReceiverModel.Attach(buffer, offset);
                    Debug.Assert(GetSymbolResponseReceiverModel.Verify(), "com.chronoxor.simple.GetSymbolResponse validation failed!");
                    long deserialized = GetSymbolResponseReceiverModel.Deserialize(out GetSymbolResponseReceiverValue);
                    Debug.Assert((deserialized > 0), "com.chronoxor.simple.GetSymbolResponse deserialization failed!");

                    // Log the value
                    if (Logging)
                    {
                        string message = GetSymbolResponseReceiverValue.ToString();
                        listener.OnReceiveLog(message);
                    }

                    // Call receive handler with deserialized value
                    listener.OnReceive(GetSymbolResponseReceiverValue);
                    return true;
                }
                default: break;
            }
        ...
        public delegate void ReceiveResponseHandler_GetSymbolResponse(global::com.chronoxor.simple.GetSymbolResponse response);
        public event ReceiveResponseHandler_GetSymbolResponse ReceivedResponse_GetSymbolResponse = (response) => {};
        ...
        public delegate void ReceiveResponseHandler_NewMdNotify(global::com.chronoxor.simple.NewMdNotify response);
        public event ReceiveResponseHandler_NewMdNotify ReceivedResponse_NewMdNotify = (response) => {};
        public delegate void ReceiveResponseHandler_GetSymbolRequest(global::com.chronoxor.simple.GetSymbolRequest response);
        public event ReceiveResponseHandler_GetSymbolRequest ReceivedResponse_GetSymbolRequest = (response) => {};
        ...
        public delegate void ReceiveRejectHandler_NewMdNotify(global::com.chronoxor.simple.NewMdNotify reject);
        public event ReceiveRejectHandler_NewMdNotify ReceivedReject_NewMdNotify = (reject) => {};
        public delegate void ReceiveRejectHandler_GetSymbolRequest(global::com.chronoxor.simple.GetSymbolRequest reject);
        public event ReceiveRejectHandler_GetSymbolRequest ReceivedReject_GetSymbolRequest = (reject) => {};
        public delegate void ReceiveRejectHandler_GetSymbolResponse(global::com.chronoxor.simple.GetSymbolResponse reject);
        public event ReceiveRejectHandler_GetSymbolResponse ReceivedReject_GetSymbolResponse = (reject) => {};
        ...
        public delegate void ReceiveNotifyHandler_NewMdNotify(global::com.chronoxor.simple.NewMdNotify notify);
        public event ReceiveNotifyHandler_NewMdNotify ReceivedNotify_NewMdNotify = (notify) => {};
        public delegate void ReceiveNotifyHandler_GetSymbolRequest(global::com.chronoxor.simple.GetSymbolRequest notify);
        public event ReceiveNotifyHandler_GetSymbolRequest ReceivedNotify_GetSymbolRequest = (notify) => {};
        public delegate void ReceiveNotifyHandler_GetSymbolResponse(global::com.chronoxor.simple.GetSymbolResponse notify);
        public event ReceiveNotifyHandler_GetSymbolResponse ReceivedNotify_GetSymbolResponse = (notify) => {};
    }
